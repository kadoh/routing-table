...
require('util').inherits(RoutingTable, EventEmitter);
 ...
 * @return {this}
 */
RoutingTable.prototype.start = function() {
  this.stop();
 ...
 * @return {this}
 */
RoutingTable.prototype.stop = function() {
  for (var i = 0, l = this._kbuckets.length; i < l; i++) {
 ...
 * @public
 */
RoutingTable.prototype.distance = function(peer) {
  var dist;
 ...
 */
RoutingTable.prototype.add = function(peers) {
 ...
 * @public
 */
RoutingTable.prototype.addPeer = function(peer) {
 ...
 */
RoutingTable.prototype.getClosePeers = function(id, number, exclude) {
...
RoutingTable.prototype.getPeer = function(peer) {
...
RoutingTable.prototype.removePeer = function(peer) {
  return this._kbucketFor(peer).removePeer(peer);
};

RoutingTable.prototype.getKBuckets = function() {
  return this._kbuckets;
};

RoutingTable.prototype.howManyKBuckets = function() {
  return this._kbuckets.length;
};

RoutingTable.prototype.howManyPeers = function() {
  return this._kbuckets.reduce(function(sum, kbucket) {
    return sum + kbucket.size();
  }, 0);
};

RoutingTable.prototype.getParentID = function() {
 ...
 * @private
 */
RoutingTable.prototype._kbucketIndexFor = function(peer) {
...
RoutingTable.prototype._kbucketFor = function(peer) {
  var index = this._kbucketIndexFor(peer);
  if (index !== -1)
 ...
 * @return {Object}
 */
RoutingTable.prototype.exports = function(options) {
 ...
 * @return {Boolean}
 */
RoutingTable.prototype.imports = function(routing_table) {
